...
import "../src/MorphoAavePYTStrategy.sol";
import "@oz-upgradeable/contracts/token/ERC20/IERC20Upgradeable.sol";

contract TestMorphoAavePYTStrategy is Test {
  ...
  // AA_maUSDC
  address public constant TRANCHE = 0x376B2dCF9eBd3067BB89eb6D1020FbE604092212; 
  address public constant CDO = 0x9C13Ff045C0a994AF765585970A5818E1dB580F8; // maUSDC CDO
  // aUSDC
  address public constant ATOKEN = 0xBcca60bB61934080951369a648Fb03DF4F96263C;
  ...
  function setUp() public {
    ...
    strategy = new MorphoAavePYTStrategy();
    stdstore
  ...
  function testAvailableLiquidity() virtual public {
    ...
    assertEq(
      ...
      underlying.balanceOf(address(idleCDO)) + underlying.balanceOf(ATOKEN)
    );
  }
